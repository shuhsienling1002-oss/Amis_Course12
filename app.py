...
# 句子資料庫 (修正拼寫：ci mamaan)
sentences = [
    {"amis": "Mararom kako.", "chi": "我難過。", "icon": "😢", "source": "Row 243"},
    {"amis": "Macahiw kako.", "chi": "我餓了。", "icon": "🤤", "source": "Row 363"},
    {"amis": "Si'enaw ko romi'ad.", "chi": "天氣冷。", "icon": "🥶", "source": "Row 255"},
    {"amis": "Maolah kako ci mamaan.", "chi": "我喜歡爸爸。", "icon": "😍", "source": "Row 207 (修正拼寫)"},
...
with tab2:
    ...
    # Stage 2: 句型重組 (修正拼寫)
        ...
        st.caption("提示：Maolah (喜歡) + ci mamaan (爸爸 受格)")
        ...
        with c1:
            # 修正後的正確答案
            if st.button("Maolah kako ci mamaan"):
                st.balloons()
                ...
                st.rerun()
        with c2:
            if st.button("Maketer kako ci mamaan"): 
                st.error("Maketer 是生氣喔！")
